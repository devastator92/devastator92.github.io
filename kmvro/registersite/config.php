...
$CONFIG['rag_pass']		=	'Razerzone000.';		// SQL Ragnarok Password
$CONFIG['rag_db']			=	'ragnarok';		// SQL Ragnarok Database name
$CONFIG['log_db']			=	'logs_ro';		// SQL Ragnarok Log Database name

$CONFIG['cp_serv']		=	'localhost';	// SQL CP Host
$CONFIG['cp_user']		=	'root';		// SQL CP User
$CONFIG['cp_pass']		=	'Razerzone000.';		// SQL CP Password
$CONFIG['cp_db']			=	'cp_rp';			// SQL CP Database name
